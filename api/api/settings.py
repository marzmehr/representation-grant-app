...
STATIC_URL = os.getenv("WEB_BASE_HREF", "/apply-for-representation-grant/")  + "/api/static/"
...
if OIDC_RP_PROVIDER_ENDPOINT:
    ...
    OIDC_RP_AUTHENTICATION_FAILURE_REDIRECT_URI = os.getenv("OIDC_RP_FAILURE_URI", "/apply-for-representation-grant/")
    OIDC_RP_USER_DETAILS_HANDLER = "core.auth.sync_keycloak_user"
    OIDC_RP_AUTHENTICATION_REDIRECT_URI = (
        os.getenv("OIDC_RP_AUTHENTICATION_REDIRECT_URI", "/apply-for-representation-grant/")
    )
...
FORCE_SCRIPT_NAME = os.getenv("WEB_BASE_HREF", "/apply-for-representation-grant/")
LOGOUT_REDIRECT_URL = os.getenv("LOGOUT_REDIRECT_URL", "/apply-for-representation-grant/")
