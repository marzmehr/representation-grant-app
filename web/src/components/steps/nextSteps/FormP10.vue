...
import surveyJson from "./forms/form-p10.json";
...
export default class FormP10 extends Vue {
    ...
    beforeDestroy() {
        ...
        this.UpdateStepResultData({step:this.step, data: {formP10Survey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}});
    }
};
</script>
