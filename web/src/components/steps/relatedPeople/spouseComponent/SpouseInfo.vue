            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <b-card style="margin-top:2rem">
                        ...
                        <div class="mt-1">
                            <div class="my-4 text-primary" @click="showCommonLawOffInfo= !showCommonLawOffInfo" style="border-bottom:1px solid; width: 52.5rem;">
                                <span style="font-size:1.2rem;" class="fa fa-question-circle" /> 
...
export default class SpouseInfo extends Vue {
    ...
    public isDisableNext() {
        return (this.spouseExists == null || (this.spouseExists == 'Yes' && this.spouseData?.length <= 0 ) || 
            !this.spouseCompleted || this.spouseCompleted == 'No');
    }
