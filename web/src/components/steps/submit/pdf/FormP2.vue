...
<div>
    ...
    <b-card id="print" style="border:1px solid; border-radius:5px;padding:3rem 3.9rem 2rem 2.0rem;" bg-variant="white" class="mt-4 mb-3">
            ...
            <b-card border-variant="white">
                <b-row>
                    <b-col cols="4">
                        <underline-form textwidth="11.35rem" beforetext="Date" hint="" text="April 20, 2020"/>
                    </b-col>
                    <b-col cols="8">
                        <underline-form textwidth="11.35rem" beforetext="" hint="Signiture of" text=""/>
                    </b-col>
                </b-row>
            </b-card>
            ...
            <b-card border-variant="white">
                ...
                <ol style="margin:0rem 0 0 2rem;">
                    <li v-if="aliasList.length == 0" style="text-indent: 10px;">none</li>
                    <li v-else class="mb-2" style="text-indent: 10px;" v-for="(name,i) in aliasList" :key="i">{{name}}</li>                                                     
                </ol>
                ...
                <b-row>
                    <ol style="margin:0rem 0 0 0rem;">
                        <underline-form style="float: right;" textwidth="40rem" beforetext="Street number and street name: " hint="" :text="deceased.address.split(',')[0]"/>
                        <underline-form style="float: right;" textwidth="40rem" beforetext="City/Town: " hint="" :text="deceased.address.split(',')[1]"/>
                        <underline-form style="float: right;" textwidth="40rem" beforetext="Province: " hint="" :text="deceased.address.split(',')[2]"/>
                        <underline-form style="float: right;" textwidth="40rem" beforetext="Country: " hint="" :text="deceased.address.split(',')[3]"/>
                        <underline-form style="float: right;" textwidth="40rem" beforetext="Postal Code: " hint="" :text="deceased.address.split(',')[4]"/>
                    </ol>
                </b-row>
...
export default class FormP2 extends Vue {    
    ...
    deceased={fullName:"Rest In Peace", first:"Rest", middle:"In",last:"Peace", address:"0-123 st, Victoria, BC, Canada, V0i 8i8", DOD: "March 1, 2020"}
    serviceContact={address:"0-123 st, Victoria, BC, Canada V0i 8i8", phone:"+1 123 456 7890", fax:"+1 123 456 7890", email:"ABC@yahoo.ca"}
    printCertifiedCopies = 2;
    spouseName = '';
    childrenList = [];
    ...
    public getDeceasedInfo() {
        this.deceased['deceasedFirstNations'] = 'y';
        this.deceased['deceasedFirstNationsName'] = "Tswassen";
    ...
    public getRelatedPeopleInfo() {
        this.spouseName = this.deceased.fullName + "'s spouse";
        this.childrenList = [];
